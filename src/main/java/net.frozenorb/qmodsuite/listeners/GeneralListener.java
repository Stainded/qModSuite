   ...
   public void onPlayerInteractEntity(final PlayerInteractEntityEvent event) {
      ...
      if (ModUtils.isModMode(player) && StaffItems.INSPECT_BOOK.isSimilar(player.getItemInHand())) {
         if (!(event.getRightClicked() instanceof Player)) {
            FancyMessage message = (new FancyMessage("Click here to despawn this ")).color(ChatColor.BLUE).tooltip(ChatColor.GRAY + "Click to despawn").command("/despawnentity");
            message.then(EntityUtils.getName(event.getRightClicked().getType())).color(ChatColor.YELLOW).tooltip(ChatColor.GRAY + "Click to despawn").command("/despawnentity");
            message.then(".").color(ChatColor.BLUE).tooltip(ChatColor.GRAY + "Click to despawn").command("/despawnentity");
            ...
            player.sendMessage(ChatColor.GRAY + "Opening inventory of: " + ChatColor.AQUA + clicked.getName());
